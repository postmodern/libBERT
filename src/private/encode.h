...
int bert_encode_small_bignum(bert_encoder_t *encoder,unsigned int i);
int bert_encode_big_bignum(bert_encoder_t *encoder,unsigned int i);
int bert_encode_bignum(bert_encoder_t *encoder,unsigned int i);
